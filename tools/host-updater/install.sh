...
source_ref=${FRIGATE_UPDATER_REF:-feature/one-click-updater-v0.18}
...
for filename in updater.py docker-compose.updater.yaml frigate-updater.service; do
...
docker pull ghcr.io/chadakenn/frigate:0.18.0
